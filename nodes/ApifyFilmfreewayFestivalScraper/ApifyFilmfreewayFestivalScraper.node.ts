...
import { properties } from './ApifyFilmfreewayFestivalScraper.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Actor schema constants
export const ACTOR_ID = 'Frgkvw77h8aJOCL2D' as string;

export const PACKAGE_NAME = 'n8n-nodes-hypebridge-actors' as string;
export const CLASS_NAME = 'ApifyFilmfreewayFestivalScraper' as string;
export const ClassNameCamel = 'apifyFilmfreewayFestivalScraper' as string;
