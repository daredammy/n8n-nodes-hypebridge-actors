...
import { properties } from './ApifyNfm.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Actor schema constants
export const ACTOR_ID = '8XMqU9wbHagBrsqVM' as string;

export const PACKAGE_NAME = 'n8n-nodes-hypebridge-actors' as string;
export const CLASS_NAME = 'ApifyNfm' as string;
export const ClassNameCamel = 'apifyNfm' as string;
