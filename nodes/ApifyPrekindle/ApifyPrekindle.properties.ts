...
export const actorProperties: INodeProperties[] = [
  {
    ...
    "name": "startUrls",
    "description": "Prekindle URLs to scrape. Supports search URLs with filters, venue pages, and direct event URLs.",
    "required": true,
    "default": {},
  ...
  },
  {
    ...
    "description": "When enabled, visits each event page to fetch complete details including full description and organizer information. Additional charges apply per event detail scraped.",
    "required": false,
    "default": true,
    "type": "boolean"
  }
