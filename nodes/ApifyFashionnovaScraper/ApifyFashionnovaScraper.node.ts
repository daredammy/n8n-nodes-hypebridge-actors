...
import { properties } from './ApifyFashionnovaScraper.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Actor schema constants
export const ACTOR_ID = 'Jd8z3QPUhuSC2QtmI' as string;

export const PACKAGE_NAME = 'n8n-nodes-hypebridge-actors' as string;
export const CLASS_NAME = 'ApifyFashionnovaScraper' as string;
export const ClassNameCamel = 'apifyFashionnovaScraper' as string;

export const X_PLATFORM_HEADER_ID = 'n8n' as string;
export const X_PLATFORM_APP_HEADER_ID = 'Jd8z3QPUhuSC2QtmI' as string;

export const DISPLAY_NAME = 'Fashion Nova Scraper' as string;
export const DESCRIPTION = 'Extracts product data from Fashion Nova using homepage URLs, category pages, search pages, and direct product URLs. It is built for product research, merchandising analysis, catalog monitoring, and structured exports you can use in spreadsheets, BI tools, or downstream automations.' as string;

export class ApifyFashionnovaScraper implements INodeType {
