...
import { properties } from './ApifyBlindPostScraper.properties';
...
export const CLASS_NAME = 'ApifyBlindPostScraper' as string;
export const ClassNameCamel = 'apifyBlindPostScraper' as string;
...
export class ApifyBlindPostScraper implements INodeType {
