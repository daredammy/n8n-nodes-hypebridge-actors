...
export const ClassNameCamel = 'apifyPartifulEventsScraper' as string;

export const X_PLATFORM_HEADER_ID = 'n8n' as string;
export const X_PLATFORM_APP_HEADER_ID = '8cRUPgqAkvHAmL4Wn' as string;

export const DISPLAY_NAME = 'Partiful Events Scraper' as string;
export const DESCRIPTION = 'Scrape public Partiful explore feeds, event pages, host profiles, and host-published events with direct HTTP calls.' as string;
